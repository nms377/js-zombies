...
eat(itemToEat){
  if(itemToEat instanceof Food){  //is item food?
    if(this._pack.indexOf(itemToEat) > -1){ //is item in the pack?

      this._pack.splice(this._pack.indexOf(itemToEat), 1);  //remove item from pack
